...
namespace Spawn_Monsters
{
    ...
    internal class MonsterPlaceMenu : IClickableMenu
    {
        ...
        // private readonly Texture2D placementTile; // Убрали эту строку
            ...
            : base(0, 0, Game1.viewport.Width, Game1.viewport.Height)
        {
            ...
            // placementTile = modHelper.Content.Load<Texture2D>("LooseSprites/buildingPlacementTiles"); // Убрали эту строку
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            // b.Draw(placementTile, mousePosition, placementTileSourceRect, Color.White); // Убрали эту строку
            if (monster == MonsterData.Monster.CursedDoll)
            {
